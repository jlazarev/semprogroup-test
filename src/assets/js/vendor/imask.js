(function (global, factory) {
    ...
    */
    bindEvents(handlers) {
      Object.keys(handlers).forEach(event =>
        this._toggleEventHandler(HTMLMaskElement.EVENTS_MAP[event], handlers[event])
      );
    }
  ...
  class InputMask {
    ...
    */
    ...
    maskEquals(mask) {
      ...
      return (
        mask == null ||
        ((_this$masked = this.masked) == null ? void 0 : _this$masked.maskEquals(mask))
      );
    }
    ...
    _onInput(e) {
      ...
      const removeDirection =
        oldRawValue === this.masked.rawInputValue ? details.removeDirection : DIRECTION.NONE;
    ...
    splice(start, deleteCount, inserted, removeDirection, flags) {
      ...
      if (removeDirection !== DIRECTION.NONE) {
        startChangePos = this.nearestInputPos(
          start,
          deleteCount > 1 && start !== 0 && !eagerRemove ? DIRECTION.NONE : removeDirection
        );
  ...
  class PatternCursor {
    ...
    _pushLeft(fn) {
      ...
      for (
        ...
        --this.index,
          this.offset =
            ((_this$block = this.block) == null ? void 0 : _this$block.displayValue.length) || 0
      ) {
        var _this$block;
  ...
  class PatternInputDefinition {
    ...
    currentMaskFlags(flags) {
      ...
      return {
        ...flags,
        _beforeTailState:
          (flags == null || (_flags$_beforeTailSta = flags._beforeTailState) == null
            ? void 0
            : _flags$_beforeTailSta.masked) || (flags == null ? void 0 : flags._beforeTailState),
      };
    }
  }
  ...
  class MaskedPattern extends Masked {
    ...
    _appendEager() {
      ...
      const details = new ChangeDetails();
      let startBlockIndex =
        (_this$_mapPosToBlock = this._mapPosToBlock(this.displayValue.length)) == null
          ? void 0
  ...
  class MaskedDynamic extends Masked {
    ...
    appendTail(tail) {
      ...
      return details.aggregate(
        this.currentMask ? this.currentMask.appendTail(tail) : super.appendTail(tail)
      );
    }
    currentMaskFlags(flags) {
    ...
    get isComplete() {
      ...
      return Boolean(
        (_this$currentMask2 = this.currentMask) == null ? void 0 : _this$currentMask2.isComplete
      );
    }
    get isFilled() {
      var _this$currentMask3;
      return Boolean(
        (_this$currentMask3 = this.currentMask) == null ? void 0 : _this$currentMask3.isFilled
      );
    }
    remove(fromPos, toPos) {
      const details = new ChangeDetails();
    ...
    get state() {
      ...
      return {
        ...
        currentMask:
          (_this$currentMask4 = this.currentMask) == null ? void 0 : _this$currentMask4.state,
      };
    }
    set state(state) {
  ...
  MaskedDynamic.DEFAULTS = {
    dispatch: (appended, masked, flags, tail) => {
      ...
      inputs.sort(
        (i1, i2) => i2.weight - i1.weight || i2.totalInputPositions - i1.totalInputPositions
      );
  ...
  class MaskedNumber extends Masked {
    ...
    _updateRegExps() {
      ...
      const mid = '\\d*';
      const end =
        (this.scale ? '(' + escapeRegExp(this.radix) + '\\d{0,' + this.scale + '})?' : '') + '$';
